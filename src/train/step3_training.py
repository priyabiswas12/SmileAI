...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_path, val_path, model_op_path, model_name):
        ...
        model_path = model_op_path
        model_name = model_name # need to define
        ...
        for epoch in range(num_epochs):
            ...
            stat.to_csv('./src/train/losses_metrics_vs_epoch.csv')
